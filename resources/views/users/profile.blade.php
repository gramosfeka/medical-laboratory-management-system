                ...
                <div class="card-body">
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-10 offset-md-2">
                            ...
                            <div class="form-group row" style="text-align: right;">
                                <label class="form-inline col-sm-2 col-form-label text-right" for="surname" style="display: block;">Surname:</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row" style="text-align: right;">
                                <label class="form-inline col-sm-2 col-form-label" for="email" style="display: block;">Email:</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row" style="text-align: right;">
                                <label class="form-inline col-sm-2 col-form-label" for="address" style="display: block;">Address:</label>
                                <div class="col-sm-10">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('profile.updatePassword') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-10 offset-md-2">
                        <div class="form-group row"  style="text-align: right;">
                            <label class="form-inline col-sm-3 col-form-label " for="current_password" style="display: block;" >Old Password:</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row" style="text-align: right;">
                            <label class="form-inline col-sm-3 col-form-label text-right" for="password" style="display: block;">New Password:</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row"style="text-align: right;">
                            <label class="form-inline col-sm-3  col-form-label" for="password_confirmation" style="display: block;">Password confirm:</label>
                            <div class="col-sm-9">
