                    ...
                    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-10 offset-md-2">
                            ...
                            <div class="form-group row" style="text-align: right;">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="address" id="address" value="{{ old('address') }}" placeholder="" class="form-control @error('address') is-invalid @enderror">
                                    @error('address')
                                    <span class="invalid-feedback text-left" role="alert">
                                            {{ $message }}
                                        </span>
                            ...
                            <div class="form-group row" style="text-align: right;">
                            <label class="form-inline col-sm-2 col-form-label" for="role" style="display: block;">Role:</label>
