...
{{--                            <img src="{{asset('img/laboratory-medicine.jpg')}}" alt="Medical Laboratory" width="562" class="img-responsive" style="border: none; -ms-interpolation-mode: bicubic; max-width: 100%;">--}}
{{--                        </td>--}}
{{--                    </tr>--}}
